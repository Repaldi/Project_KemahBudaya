    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <header class="section-header">
          <h3 class="section-title">YUK CEK PESANAN MU?</h3>
        </header>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Menunggu</li>
              <li data-filter=".filter-card">Diterima</li>
              <li data-filter=".filter-web">Ditolak</li>
            </ul>
          </div>
        </div>
